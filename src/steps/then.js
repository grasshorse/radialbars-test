...
import checkIfElementExists from '../support/dsl/checkIfElementExists';
...
defineSupportCode(({ Then }) => {
    ...
    Then(/^I wait on element "([^"]*)?"(?: for (\d+)ms)*(?: to( not)* (be checked|be enabled|be selected|be visible|contain a text|contain a value|exist))*$/, { wrapperOptions: { retry: 3 } }, waitFor);
